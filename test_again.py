...
synthetic = pd.read_csv('synthetic.csv')  # oletetaan että valmiiksi oikeassa mittakaavassa

# Ladataan skaalaustiedot
with open('scalers.pkl', 'rb') as f:
    scalers = pickle.load(f)

# Valitaan X-muuttujat
...
with open("synthetic_eval_summary.txt", "w") as f:
    f.write("🧪 TESTI: Real vs Synthetic\n")
...
print("✅ Tulokset tallennettu tiedostoon: synthetic_eval_summary.txt")
